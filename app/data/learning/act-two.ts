...
export const actTwoLessons: LessonNodeConfig[] = [
  { id: "section-2-lvl-1", x: 185, y: 90, title: "Tentang Diriku", lessonLabel: "Lesson 1/5", xp: 10, available: true, icon: "/Levels/active.png", iconAlt: "Available lesson" },
  { id: "section-2-lvl-2", x: 235, y: 230, title: "Salam dan Sapaan", lessonLabel: "Lesson 2/5", xp: 10, available: true, icon: "/Levels/inactive.png", iconAlt: "Locked lesson" },
  {
    id: "section-2-lvl-3", x: 170, y: 370, title: "Barang Dalam Kelas", lessonLabel: "Lesson 3/5", xp: 10, available: true, icon: "/Levels/inactive.png", iconAlt: "Locked lesson",
    reward: { name: "yoghurt", image: "/quest/yoghurt.png", alt: "Yoghurt reward", offsetX: 55, offsetY: 40, width: 64 },
  },
  { id: "section-2-lvl-4", x: 130, y: 510, title: "Orang Dalam Kelas", lessonLabel: "Lesson 4/5", xp: 10, available: true, icon: "/Levels/inactive.png", iconAlt: "Locked lesson" },
